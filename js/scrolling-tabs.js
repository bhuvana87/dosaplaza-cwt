;(function () {
  ...
  scrollingTabsTemplate = [
    ...
    ' <div class="scrtabs-tab-scroll-arrow scrtabs-js-tab-scroll-arrow-left"><span class="fa fa-chevron-left"></span></div>',
  ...
  scrollingTabsWrapperTemplate = [
    ...
    '   </div>',
    ' <div class="scrtabs-tab-scroll-arrow scrtabs-js-tab-scroll-arrow-right"><span class="fa fa-chevron-right"></span></div>',
    '</div>'
  ].join('');
